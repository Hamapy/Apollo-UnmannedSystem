...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        dock_status->setMinimumSize(QSize(325, 465));
        ...
        gridLayout->addWidget(btn_mapping, 10, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        pushButton->setText(QApplication::translate("MainWindowDesign", "romap", 0));
        btn_mapping->setText(QApplication::translate("MainWindowDesign", "mappping", 0));
